...
public final class add_002dmedicine_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 if (request.getAttribute("successMessage") != null) { 
      ...
      out.write("        <div>\n");
      out.write("          <h1><i class=\"fa fa-edit\"></i> Add Medicine</h1>\n");
      out.write("          \n");
      out.write("        </div>\n");
      out.write("        <ul class=\"app-breadcrumb breadcrumb\">\n");
      out.write("          <li class=\"breadcrumb-item\"><i class=\"fa fa-home fa-lg\"></i></li>\n");
      out.write("          <li class=\"breadcrumb-item\">Medicine</li>\n");
      out.write("          <li class=\"breadcrumb-item\"><a href=\"#\">Add Medicine</a></li>\n");
      out.write("        </ul>\n");
      out.write("      </div>\n");
      out.write("      <div class=\"row\">\n");
      out.write("        <div class=\"col-md-6\">\n");
      out.write("          <div class=\"tile\">\n");
      out.write("            <h3 class=\"tile-title\">Add Medicine</h3>\n");
      out.write("            <div class=\"tile-body\">\n");
      out.write("                <form action=\"Minsert\" method=\"post\">\n");
      out.write("                <div class=\"form-group\">\n");
      out.write("                  <label class=\"control-label\">Name</label>\n");
      out.write("                  <input class=\"form-control\" type=\"text\" name=\"name\" placeholder=\"Enter medicine name\">\n");
      out.write("                </div>\n");
      out.write("                <div class=\"form-group\">\n");
      out.write("                  <label class=\"control-label\">Category</label>\n");
      out.write("                  <select class=\"form-control\" name=\"category\" placeholder=\"select medicine category\" >\n");
      out.write("\t\t\t\t  <option>Antiacids & Gastritis</option>\n");
      out.write("\t\t\t\t  <option>Organic Care</option>\n");
      out.write("\t\t\t\t  <option>Pain Care</option>\n");
      out.write("\t\t\t\t  <option>Wound Care</option>\n");
      out.write("\t\t\t\t  <option>Ayurvedic Care</option>\n");
      out.write("\t\t\t\t  <option>Mother & Baby Care</option>\n");
      out.write("\t\t\t\t  <option>Personal Care</option>\n");
      out.write("\t\t\t\t  <option>Pet Care</option>\n");
      out.write("\t\t\t\t  </select>\n");
      out.write("                </div>\n");
      out.write("\t\t\t\t\n");
      out.write("\t\t\t\t\n");
      ...
      out.write("                  <select class=\"form-control\" name=\"company\" placeholder=\"select medicine company\">\n");
      out.write("\t\t\t\t  <option>Softa</option>\n");
      out.write("\t\t\t\t  <option>Dermavive</option>\n");
      out.write("\t\t\t\t  <option>Axe</option>\n");
      out.write("\t\t\t\t  <option>Moov</option>\n");
      out.write("\t\t\t\t  <option>GSK</option>\n");
      out.write("\t\t\t\t  <option>Siddhalepa</option>\n");
      out.write("\t\t\t\t  <option>Link</option>\n");
      out.write("\t\t\t\t  <option>Tylenol</option>\n");
      out.write("\t\t\t\t  <option>Panadeine</option>\n");
      out.write("\t\t\t\t  <option>Naturelle</option>\n");
      out.write("\t\t\t\t  <option>Danone</option>\n");
      out.write("\t\t\t\t  <option>Ladymil</option>\n");
      out.write("\t\t\t\t  <option>Johnson Nutrition</option>\n");
      out.write("\t\t\t\t  <option>Nestle</option>\n");
      out.write("\t\t\t\t  <option>Genove</option>\n");
      out.write("\t\t\t\t  <option>Elovera</option>\n");
      out.write("\t\t\t\t  <option>Facia</option>\n");
      out.write("\t\t\t\t  <option>Chandanalepa</option>\n");
      out.write("\t\t\t\t  <option>Cetaphil</option>\n");
      out.write("\t\t\t\t  <option>KF94</option>\n");
      out.write("\t\t\t\t  <option>VWash</option>\n");
      out.write("\t\t\t\t  <option>Mackerel</option>\n");
      out.write("\t\t\t\t  <option>Whiskus</option>\n");
      out.write("\t\t\t\t  <option>Pedigree</option>\n");
      out.write("\t\t\t\t  <option>Andy</option>\n");
      out.write("\t\t\t\t  <option>CP</option>\n");
      out.write("\t\t\t\t  <option>SmartHeart</option>\n");
      out.write("\t\t\t\t  <option>Iger Pet</option>\n");
      out.write("\t\t\t\t  <option>Malibon</option>\n");
      out.write("\t\t\t\t  </select>\n");
      out.write("                </div>\n");
      out.write("\t\t\t\t\n");
      out.write("\t\t\t\t<div class=\"form-group\">\n");
      out.write("                  <label class=\"control-label\">Quantity</label>\n");
      out.write("                  <input class=\"form-control\" type=\"number\" name=\"quantity\" min=\"0\" max=\"50000\" step=\"1\" placeholder=\"Enter medicine quantity\">\n");
      out.write("\t\t\t\t  \n");
      out.write("                </div>\n");
      out.write("\t\t\t\t\n");
      out.write("\t\t\t\t<div class=\"form-group\">\n");
      out.write("                  <label class=\"control-label\">Expire Date</label>\n");
      out.write("                  <input class=\"form-control\" type=\"date\" name=\"expireDate\" placeholder=\"Enter medicine category\">\n");
      out.write("                </div>\n");
      out.write("\t\t\t\t\n");
      out.write("\t\t\t\t\n");
      out.write("\t\t\t\t\n");
      ...
      out.write("                  <input class=\"form-control\" type=\"number\" name=\"price\" min=\"0\" max=\"50000\" step=\"1\" placeholder=\"LKR\">\n");
      out.write("\t\t\t\t  \n");
      out.write("                </div>\n");
      out.write("               \n");
      out.write("                <!--<div class=\"form-group\">\n");
      out.write("                  <label class=\"control-label\">Medicine Image</label>\n");
 ...
 if (request.getAttribute("insertSuccess") != null) { 
      ...
      out.write("            alert(\"Medicine added successfully\");\n");
      out.write("        }\n");
      out.write("    </script>\n");
 } 
      out.write("\n");
